...
public class Worker {
    ...
    final ImageIcon iconMembers = new ImageIcon(url2);
    ...
    private void uplaod() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                bdeletemember.setEnabled(true);
                bload.setEnabled(true);
                bpay.setEnabled(true);
            } else {
                Toolkit.getDefaultToolkit().beep();
                table.setModel(pharmacymodel);
                JOptionPane.showMessageDialog(null, "No Workers In The Store", "Notification", JOptionPane.ERROR_MESSAGE);
                rs.close();
                stmt.close();
                con.close();
                ...
                bdeletemember.setEnabled(false);
    ...
    private void addworker() {
        ...
        if (tnidadd.getText().equalsIgnoreCase("") && tpnumberadd.getText().equalsIgnoreCase("") && tusernameadd.getText().equalsIgnoreCase("") || ttpaymentdd.getText().equalsIgnoreCase("")) {
            JOptionPane.showMessageDialog(null, "Please Enter Details Of New Worker", "Membership Message", JOptionPane.INFORMATION_MESSAGE, iconMembers);
        } else {
            try {
                ...
                if (selloption == 0) {
                    if (admin.equalsIgnoreCase(addtype)) {
                        ...
                        if (prs2 != null) {
                            ...
                            JOptionPane.showMessageDialog(null, tusernameadd.getText() + " " + "Added Successful", "New Worker Confirmation", JOptionPane.INFORMATION_MESSAGE, iconMembers);
                            rs.close();
                            prs.close();
                            prs2.close();
                            con.close();
    ...
    private void searchengine() {
        ...
        if (valuesearch.equalsIgnoreCase("") || valuesearch.equalsIgnoreCase(null)) {
            JOptionPane.showMessageDialog(null, "Please Enter The Worker Name/National_ID/Personal Number For Search", "Membership Message", JOptionPane.INFORMATION_MESSAGE, iconMembers);
        } else {
            DefaultTableModel pharmacymodel = new DefaultTableModel();
            //dm.addColumn("Medicine Name");
            pharmacymodel.setColumnIdentifiers(values);
    ...
    public void workers() {
        ...
        ltotalpayments = new JLabel("Total Payments[KES]");
        ltotalpayments.setFont(new Font("Tahoma", Font.PLAIN, 13));
        ltotalcost = new JLabel("Total Salaries[KES]");
