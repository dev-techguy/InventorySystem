...
public class AnalysisType {
    ...
    URL url5 = Main.class.getResource("/img/solditems.png");
    ...
    ImageIcon imagesold = new ImageIcon(url5);
    ...
    //setting labels
    JLabel llogo, llogo2, ltitle, larchives, lstock, lsupply, lsold;
    JButton bpayments, bstock, bdistributers, bback, bsold;
    ...
    public void ChooseSection() {
        ...
        lsold = new JLabel("Sold Records");
        lsold.setFont(new Font("Tahoma", Font.PLAIN, 13));
        ...
        bsold = new JButton(imagesold);
        bsold.setToolTipText("Analyze past sold products");
        bsold.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        v.insets = new Insets(30, 0, 0, 200);
        v.ipadx = 0;
        v.ipady = 0;
        v.gridx = 0;
        v.gridy = 3;
        ...
        v.insets = new Insets(0, 0, 30, 200);
        v.gridy++;
        panelanalysis.add(lstock, v);
        v.insets = new Insets(0, 0, 0, 200);
        v.gridy++;
        ...
        v.insets = new Insets(0, 0, 0, 0);
        v.gridy++;
        panelanalysis.add(bsold, v);
        v.gridy++;
        panelanalysis.add(lsold, v);
        ...
        bsold.addActionListener(e -> {
            Fanalysis.setVisible(false);
            SoldRecords soldRecords = new SoldRecords();
            soldRecords.pastSoldRecords();
