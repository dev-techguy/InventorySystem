...
public class SuppliersAnalysis {
    ...
    private void searchengine() {
        ...
        if (valuesearch.equalsIgnoreCase("") || valuesearch.equalsIgnoreCase(null)) {
            JOptionPane.showMessageDialog(null, "Please Enter The Product Name/Serial Number/Company Name For Search", "Search Message", JOptionPane.INFORMATION_MESSAGE, iconPayments);
        } else {
    ...
    public void uplaod() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Toolkit.getDefaultToolkit().beep();
                table.setModel(pharmacymodel);
                JOptionPane.showMessageDialog(null, "No Suppliers In The Store", "Notification", JOptionPane.ERROR_MESSAGE);
                rs.close();
                stmt.close();
                con.close();
    ...
    private void supplierpayments() {
        try {
            ...
            if (serialgot.equalsIgnoreCase("") || serialgot.equalsIgnoreCase(null)) {
                ...
                int selloption = JOptionPane.showOptionDialog(null, "Proceed in Paying" + " " + tdname.getText() + " " + "Details with Serial_Number" + " " + serialgot, "Payment Confirmation", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, iconPayments, option, option[1]);
                if (selloption == 0) {
    ...
    public void Suppliers() {
        ...
        ltotalpayments = new JLabel("[KES]Total Payments");
        ltotalpayments.setFont(new Font("Tahoma", Font.PLAIN, 15));
        ltotalcost = new JLabel("Total Amount[KES]");
        ltotalcost.setFont(new Font("Tahoma", Font.PLAIN, 15));
        ltotalbalance = new JLabel("[KES]Total Balance");
        ...
        lpayed = new JLabel("[KES]Amount Paid");
        lpayed.setFont(new Font("Tahoma", Font.PLAIN, 15));
        lpay = new JLabel("[KES]Pay");
        lpay.setFont(new Font("Tahoma", Font.PLAIN, 15));
        lbalance = new JLabel("[KES]Balance");
