...
public class Login {
    ...
    /// variables
    private String type2 = "Choose Login Type";
    ...
    public void LoginSection() {
        ...
        String[] options = {"Choose Login Type", "Admin", "User"};
...
//        ltype.addItem("User_Login");
        ...
        blogin.addActionListener(e -> {
            String admin = "Admin";
            String user = "User";
            String developer = "Choose Login Type";
//                //database start
...
//                System.out.println(Aname + Apass);
            if (type2.equalsIgnoreCase(admin)) {
                    ...
                    if (con != null) {
                        if (Aname.equalsIgnoreCase("") && Apass.equalsIgnoreCase("")) {
                            ...
                            if (rs.next()) {
                                ...
                                JOptionPane.showMessageDialog(null, "Wrong Details\nPlease Check and try again", "Login Notification", JOptionPane.WARNING_MESSAGE);
            ...
            } else if (type2.equalsIgnoreCase(developer) || type2 == null) {
                ...
                if (tusername.getText().equalsIgnoreCase(systemname) && tpassword.getText().equalsIgnoreCase(systempass)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please Choose Login Type", "Notification", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
